...
public class GenericDaoHibernateImpl<T, PK extends Serializable> implements GenericDao<T, PK>, FinderExecutor {
    ...
    private FinderNamingStrategy namingStrategy = (FinderNamingStrategy) new SimpleFinderNamingStrategy(); // Default. Can override in config
    private FinderArgumentTypeFactory argumentTypeFactory = (FinderArgumentTypeFactory) new SimpleFinderArgumentTypeFactory(); // Default. Can override in config
